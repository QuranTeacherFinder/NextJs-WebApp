...
const Footer: React.FC<Props> = ({ links, logo, socialLinks }) => {
  const Styles = {
    ...
    SocialLink: 'cursor-pointer inline-block text-bg hover:text-gray-500 transition duration-300 mx-4',
    ...
    <div className={Styles.Container}>
      <div className={Styles.Content}>
        <div className={Styles.Row}>
          ...
          <p className={Styles.CopyrightText}>&copy; Copyright 2020, QariFinder Inc. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  )
